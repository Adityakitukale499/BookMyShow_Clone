            ...
            <Modal.Body>
                <div className="container">
                    ...
                    <div className="modal_right_side">
                        <h3>{movie.title}</h3>
                        <p><i className="fa-solid fa-star" style={{ color: 'rgb(236, 94, 113)' }}></i><strong>{movie?.vote_average} %</strong> &nbsp; &nbsp; <strong>Votes : {movie?.vote_count}K</strong></p> <p><strong>Overview: </strong>{movie.overview}</p>
                        <h5>Price: {price}</h5>
                        <button onClick={handlePament} className='bookBtn'>book now</button>
                    </div>
                </div>
            </Modal.Body>
        </Modal>
